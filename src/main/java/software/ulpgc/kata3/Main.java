...
import software.ulpgc.kata3.barPlot.BarChart;
import software.ulpgc.kata3.barPlot.swing.MainFrame;
...
public class Main {
    public static void main(String[] args) {
        ...
        for (String year : years) {
            Double v = Double.valueOf(map.get(year));
            values.add(v);
        }

        MainFrame frame = new MainFrame();
        frame.barChartDisplay().show(new BarChart(values, years, null));
